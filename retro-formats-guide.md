...
> The wrong format for the wrong moment wastes everyone's time. This guide helps you pick the right format based on team context, sprint mood, and what you're trying to achieve.
...
| After a rough or stressful sprint | Mad / Sad / Glad |
| Team losing sight of goals | Sailboat |
| Mature team, process-heavy sprint | DAKI |
| Mid-project check-in | 4Ls |
| After a PI or major release | DAKI or 4Ls |
| Team energy is low, morale needs a reset | Mad / Sad / Glad or Sailboat |
| Team is doing well, want to build on it | 4Ls or Start / Stop / Continue |

---

## Format 1: Start / Stop / Continue

**When to use:** Default format. Safe for new teams, post-difficult sprints, or when you need structure.
...
- If the team is reluctant to add to STOP, try: *"If a new team member joined tomorrow, what would you tell them not to bother with?"*
- Every START item needs a committed owner before the retro closes.
...
**When to use:** When the team is losing motivation or disconnected from goals. Reconnects people to purpose.
...
**When to use:** After high-stress sprints. When morale needs attention. When something significant happened.
...
## Anti-patterns to avoid across all formats

| Anti-pattern | What it looks like | What to do instead |
|---|---|---|
| Retro without actions | Great discussion, nothing committed | Close every retro with a named action list |
| Same format every sprint | Team goes through the motions | Rotate formats every 2–3 sprints |
| SM dominates | SM talks more than the team | SM facilitates, team generates content |
| Actions never followed up | Last sprint's actions forgotten | Open every retro reviewing previous actions |
| Blame creep | Discussion gets personal | Redirect to process, not people |
| Running over time | Retro bleeds into other meetings | SM owns the clock, hard stop at timebox |
